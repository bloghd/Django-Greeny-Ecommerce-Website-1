    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.CharField(default=products.models.generaste_code, max_length=15, verbose_name='SKU')),
                ...
                ('flag', models.CharField(blank=True, choices=[('New', 'New'), ('Featured', 'Featured')], max_length=50, verbose_name='flag')),
